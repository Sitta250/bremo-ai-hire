const data = {
  "scenario_id": "S05",
  "scenario_name": "EU Regulatory / ESG Pressure Shock",
  "scenario_category": "regulatory",
  "description": "EU Battery Directive enforcement, carbon border adjustment mechanisms, and accelerated net-zero expectations are now directly affecting BMW's EV operating model. Compliance is no longer treated as a reporting layer sitting beside production; it is becoming embedded in supplier qualification, quality traceability, material transparency, and production decision-making. The Head of Production for the EV Division must ensure the plant network can demonstrate regulatory readiness while preserving premium product standards and execution credibility.\n\nThis scenario does not reward a pure launch specialist or a classic plant firefighter. It favors a quality-and-governance-oriented leader who can translate regulation into operational control, align internal and external stakeholders, and redesign production accountability so compliance, traceability, and execution stay integrated. The winner here is the leader who can prevent BMW from drifting into a technically compliant but operationally brittle state.",
  "business_context": {
    "market_conditions": "Premium EV competition remains strong, but regulatory compliance and sustainability performance increasingly influence brand trust and market access.",
    "supply_chain_status": "Battery and materials suppliers face rising traceability, emissions, and documentation requirements, increasing audit burden and qualification complexity.",
    "internal_pressures": "Executives demand credible progress toward net-zero by 2028, stronger traceability, and avoidance of compliance failures that could damage the BMW brand.",
    "timeline_pressures": "Regulatory milestones are fixed, with limited flexibility; readiness must be achieved in defined phases over the next 12-24 months.",
  ...
  "expected_winner_archetype": "A governance-heavy production leader with deep quality systems credibility, strong cross-functional influence, and the ability to operationalize regulatory and ESG requirements without losing control of execution.",
  "risk_of_wrong_hire": "If BMW hires a speed-oriented launch leader or a people-centric transformer for this scenario, the organization may underinvest in process control and traceability. That could produce audit failures, supplier non-compliance, production holds, 1-3 months of disruption in affected lines, and €60-140M in penalties, rework, delayed deliveries, and reputational damage.",
  "key_differentiator": "C4 quality management is the decisive swing, reinforced by C8 stakeholder management and C10 change management."
} as const;

export const S05 = data;
export default data;
