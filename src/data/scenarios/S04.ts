const data = {
  "scenario_id": "S04",
  "scenario_name": "Talent War / Engineering Retention Emergency",
  "scenario_category": "competitive",
  "description": "BMW's EV Division in EMEA is facing a severe talent market shock. Amazon, Tesla, and several software-centric mobility players have aggressively targeted automation engineers, data specialists, and high-potential manufacturing leaders, driving attrition to 15% in critical talent pools. The immediate issue is not physical plant disruption; it is capability erosion inside the operating system. If leadership cannot stabilize and re-motivate the organization, execution risk will compound over the next 12 months as institutional knowledge leaks out.\n\nIn this environment, the Head of Production must become a talent stabilizer and organizational transformer, not just a plant manager. The winning leader is the one who can retain key people, rebuild managerial trust, modernize how teams work, and make BMW's production organization feel like a place ambitious technical talent wants to stay. A traditional operator may keep the lines running for a quarter; the wrong people strategy will still hollow out the system underneath.",
  "business_context": {
    "market_conditions": "Competition for EV and digital manufacturing talent is intense across Europe, especially in automation, data, and advanced production roles.",
    "supply_chain_status": "Supply chain is relatively stable, but capability gaps in engineering and operations execution are growing internally.",
    "internal_pressures": "Leadership must stop critical attrition, protect execution continuity, and maintain employer credibility in a highly visible talent market.",
    "timeline_pressures": "Retention interventions must show effect within one to two quarters before expertise loss begins impairing production and launches.",
  ...
  "expected_winner_archetype": "A people-first transformation leader who can retain high-skill technical teams, modernize the operating environment, and lead through influence rather than hierarchy alone.",
  "risk_of_wrong_hire": "If BMW hires a conventional plant operator for this scenario, the organization may preserve surface-level production discipline while losing critical technical capability underneath. The likely result is another 8-12% attrition in targeted roles, delayed automation initiatives, reduced management credibility, and €40-90M in replacement, productivity, and program-delay costs.",
  "key_differentiator": "The swing is driven by C5 team leadership at scale, with C10 change management as the decisive amplifier."
} as const;

export const S04 = data;
export default data;
