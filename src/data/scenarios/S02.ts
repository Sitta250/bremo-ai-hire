const data = {
  "scenario_id": "S02",
  "scenario_name": "Semiconductor Supply Crisis / Allocation War Room",
  "scenario_category": "crisis",
  "description": "A major semiconductor supplier serving multiple European OEMs has suffered a factory fire, removing a critical control-unit source for at least six months. BMW's EV Division now faces constrained allocation across plants, uncertain supplier recovery timelines, and difficult trade-offs between premium model mix, production continuity, and customer delivery commitments. The Head of Production for EMEA is no longer operating in a steady-state manufacturing environment; the role becomes a daily command function that must coordinate supply, production sequencing, commercial priorities, and executive escalation.\n\nThis is not a scenario where the best standard operator wins. The top candidate here is the one who can run crisis rooms, make hard allocation decisions under uncertainty, negotiate across functions and suppliers, and preserve output where possible without allowing panic, hidden inventory distortions, or plant-level chaos to spread through the network.",
  "business_context": {
    "market_conditions": "Customer demand remains intact, but constrained supply means BMW cannot satisfy all orders and must prioritize strategically.",
    "supply_chain_status": "A critical semiconductor node is disrupted for six months, with recovery timing uncertain and second-source qualification incomplete.",
    "internal_pressures": "Executives require daily visibility, rapid scenario planning, and defensible allocation decisions across markets and plants.",
    "timeline_pressures": "Immediate response is required within days, followed by sustained cross-functional coordination over a six-month disruption period.",
  ...
  "expected_winner_archetype": "A battle-tested crisis operator with strong supplier-risk instincts, enterprise-level stakeholder influence, and a track record of managing multi-month production disruptions without organizational breakdown.",
  "risk_of_wrong_hire": "If BMW hires a baseline plant operator or a digital transformation specialist for this scenario, the likely result is poor allocation logic, cross-functional conflict, and escalating downtime. That can translate into 4-8 weeks of avoidable output loss, expedited logistics costs, plant inefficiency, and €80-180M of additional financial damage on top of the underlying disruption.",
  "key_differentiator": "The swing comes from C9 crisis management, with C3 supply chain risk management as the decisive supporting factor."
} as const;

export const S02 = data;
export default data;
