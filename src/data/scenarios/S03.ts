const data = {
  "scenario_id": "S03",
  "scenario_name": "Neue Klasse EV Acceleration / Debrecen SOP Compression",
  "scenario_category": "acceleration",
  "description": "The BMW Board has pulled forward the required start-of-production timeline for Debrecen by six months in order to accelerate Neue Klasse competitiveness in Europe. The role of Head of Production for the EV Division now shifts from optimized steady-state management to industrialization at speed. The operating question is no longer whether the plant can launch well under normal timing assumptions, but whether it can compress ramp-up activities without losing control of process stability, automation readiness, and launch sequencing.\n\nThis scenario rewards leaders who can drive accelerated readiness across manufacturing engineering, automation, supplier onboarding, launch governance, and organizational change. Traditional BMW operating discipline still matters, but it is no longer enough. The winner must be able to move a complex production system faster than its default cadence without letting the organization snap.",
  "business_context": {
    "market_conditions": "Competitive pressure in premium EVs has intensified, pushing BMW to accelerate capacity and launch timing.",
    "supply_chain_status": "Supply conditions are manageable but stressed by the compressed industrialization schedule and supplier readiness dependencies.",
    "internal_pressures": "Board-level visibility is high, and the launch is strategically symbolic for BMW's next-generation EV platform.",
    "timeline_pressures": "A six-month acceleration creates severe pressure on SOP readiness, equipment validation, workforce training, and process stabilization.",
  ...
  "expected_winner_archetype": "A launch-and-transformation leader with deep SOP and ramp-up credibility, strong digital manufacturing fluency, and the ability to force organizational acceleration without losing production control.",
  "risk_of_wrong_hire": "If BMW hires a stable operator or a pure crisis firefighter instead of a launch-acceleration leader, the likely outcome is a 3-6 month slip, unstable commissioning, high rework during ramp, and €100-220M in delayed revenue plus launch inefficiency costs.",
  "key_differentiator": "C2 ramp-up & SOP expertise is the main swing factor, amplified by C7 digital manufacturing and C10 change management."
} as const;

export const S03 = data;
export default data;
